...
class Module:
    ...
    def buffers(self, recurse: bool = True) -> Iterable[Tensor]: ...
    def modules(self) -> Iterable[Module]: ...
    def children(self) -> Iterable[Module]: ...

    def named_parameters(self, prefix: str = '', recurse: bool = True) -> Iterable[Tuple[str, Parameter]]: ...
    def named_buffers(self, prefix: str = '', recurse: bool = True) -> Iterable[Tuple[str, Tensor]]: ...
    def named_modules(self, memo: None = None, prefix: str = '') -> Iterable[Tuple[str, Module]]: ...
